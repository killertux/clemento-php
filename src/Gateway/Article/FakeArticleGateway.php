...
class FakeArticleGateway implements ArticleGateway
{
	...
	{
		$this->articles = [
			new Article(ArticleId::fromString('01HN6DDPJ0TSCSP1EZCDM5FTNJ'), ArticleType::Regular, new Author('Bruno Clemente'), new Chronos('2024-01-12 22:43:12'), new Chronos('2024-01-12 22:43:12'), new Title('Some Article'), new Body('A lot of stuff in the body')),
